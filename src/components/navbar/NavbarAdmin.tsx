...
export default function AdminNavbar(props: {
  ...
  const handleLLMChange = (llm: string) => {
    ...
    llm.includes("GPT")
      ? setSelectedLLMLogo(chatgpt)
      : setSelectedLLMLogo(claude);
    setSelectedLLM(llm);
  };
    ...
    >
      ...
      >
        <Box mb={{ sm: "8px", md: "0px" }}>
          <Text color={secondaryText} fontSize="sm" mb="10px">
            Pages /
          </Text>
            ...
            >
              ...
              <Flex flexDirection="column" p="10px">
                ...
                <MenuItem
                  ...
                  borderRadius="8px"
                  px="14px"
                  onClick={() => handleLLMChange("Claude V3.5 Haiku")}
                >
                  <Text fontSize="sm">Claude V3.5 Haiku</Text>
                </MenuItem>
                <MenuItem
                  bg={menuBg}
                  _hover={{ bg: menuColor }}
                ...
                <MenuItem
                  ...
                  borderRadius="8px"
                  px="14px"
                  onClick={() => handleLLMChange("Claude V3.5 v2 Sonnet")}
                >
                  <Text fontSize="sm">Claude V3.5 v2 Sonnet</Text>
                </MenuItem>
                <MenuItem
                  bg={menuBg}
                  _hover={{ bg: menuColor }}
                  ...
                  borderRadius="8px"
                  px="14px"
                  onClick={() => handleLLMChange("Claude V3.7 Sonnet")}
                >
                  <Text fontSize="sm">Claude V3.7 Sonnet</Text>
                </MenuItem>
              </Flex>
