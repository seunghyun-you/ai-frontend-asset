...
interface MaintenanceSourceDocumentHistoryProps {
	title: string;
...
export default function MaintenanceSourceDocumentHistory(
	{
		title,
		ranking,
		link,
		image,
		...rest
	}: MaintenanceSourceDocumentHistoryProps
) {
	...
	return (
		<Card bg={bg} {...rest} p='14px' key={ranking}>
			<Flex align='center' direction={{ base: 'column', md: 'row' }}>
				...
				<Link href={link} variant='no-hover' me='16px' ms='auto' p='0px !important' target='_blank'>
